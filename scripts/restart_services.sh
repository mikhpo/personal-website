...
# Показывает статус перезапущенных сервисов.
...
#############################################
# Перезапуск кластера PostgreSQL и вывод текущего статуса кластера после перезапуска.
#############################################
restart_postgresql() {
...
#############################################
# Перезапуск Gunicorn и вывод текущего статуса сервиса после перезапуска. 
...
#############################################
# Перезапуск Nginx и вывод текущего статуса сервиса после перезапуска.
