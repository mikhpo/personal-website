---
name: server-setup
description: Первоначальная настройка нового сервера под Docker-развертывание проекта или миграция на новый сервер. Скилл дополняет scripts/docker/setup.sh знанием об окружении, которое скрипт не учитывает.
---
