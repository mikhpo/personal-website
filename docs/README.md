...
* `config` - каталог с настройками проекта и центральным маршрутизатором.
...
Статические файлы - это CSS-библиотеки, JavaScript-модули, фавиконы и др. Все статические файлы собраны в каталоге `staticfiles`.
