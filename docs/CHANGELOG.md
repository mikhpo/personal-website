...
- Унифицирована логика публичности объектов с полем public (Album, Photo, Article, Category, Topic, Series): списки и sitemap показывают только public=True, детальный просмотр любого объекта по прямой ссылке доступен всем (share-by-link)
