...
- Прокси-сервер nginx заменён на Traefik: обслуживает HTTPS с автоматическими сертификатами Let's Encrypt, запросы маршрутизируются по Docker-лейблам; каталог nginx/ и том nginx-certs удалены
