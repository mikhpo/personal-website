...
- Ожидание готовности MinIO в entrypoint.sh выполняется только при STORAGE_TYPE=filesystem и непустом MINIO_SERVER_URL: при STORAGE_TYPE=s3 с внешним S3 каждый старт ожидал таймаут несуществующего локального MinIO
